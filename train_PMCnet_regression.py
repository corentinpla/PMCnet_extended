...
tp['x_0'] = x_train
tp['y'] = y_train
tp['regularization_weight'] = 1.14591
...
if dogolden_search == 0:    
    ...
    with open("bug_log_BNN_regression.txt", "w") as log:
        ...
        try:
            crit = lambda reg: run_PMCnet_fixedReg_regression_extended(simulations,reg,loss,results_dir, x_val, y_val,is_binary,N,K,T,sig_prop,lr,gr_period,tp,est_ml,epsilon1,epsilon2,logger)
