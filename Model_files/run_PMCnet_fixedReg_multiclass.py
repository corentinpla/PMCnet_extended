...
def run_PMCnet_fixedReg_multiclass(simulations,reg,loss,N_resampled, results_dir, x_val, y_val1,is_binary, N,K,T,sig_prop,lr,gr_period,tp,est_ml,epsilon1,epsilon2,logger):
    ...
    for i in range(simulations): 
        ...
        output_posterior_val = BNN_posterior_multiclass(N, K, N_resampled,population, weights, x_val, y_val1, tp, is_binary)
        ...
        print('The accuracy is ', Accuracy_mean)
        # save the results
