...
def run_PMCnet_fixedReg_regression_large(simulations,reg,loss, results_dir, x_val, y_val,is_binary, N,K,T,sig_prop,lr,gr_period,tp,est_ml,epsilon1,epsilon2,logger):
    tp['regularization_weight'] = reg
    output_vec = []
    output_posterior_val_vec = []
    MSE_mean_vec = []
